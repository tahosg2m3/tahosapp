...
const en = {
  ...
  'mobile.servers': 'Servers',
  'mobile.messages': 'Messages',
  'mobile.friends': 'Friends',
  'mobile.members': 'Members',
  'mobile.chooseServer': 'Choose a server, or use + to create or join one.',
  'mobile.noChannel': 'Choose a channel',
  'mobile.chooseChannel': 'Open the channel list to start a conversation or join a voice room.',
  'mobile.browseChannels': 'Browse channels',
  'mobile.chooseConversation': 'Open your messages to choose a conversation.',
  'mobile.browseMessages': 'Browse messages',
  'mobile.writeMessage': 'Write a message',
  'mobile.send': 'Send message',
...
const tr = {
  'mobile.navigation': 'Gezinme',
  'mobile.openNavigation': 'Gezinmeyi aç',
  'mobile.servers': 'Sunucular',
  'mobile.messages': 'Mesajlar',
  'mobile.friends': 'Arkadaşlar',
  'mobile.members': 'Üyeler',
  'mobile.chooseServer': 'Bir sunucu seç veya + düğmesiyle sunucu oluştur ya da birine katıl.',
  'mobile.noChannel': 'Bir kanal seç',
  'mobile.chooseChannel': 'Sohbet etmek veya ses odasına katılmak için kanal listesini aç.',
  'mobile.browseChannels': 'Kanalları aç',
  'mobile.chooseConversation': 'Sohbet seçmek için mesajlarını aç.',
  'mobile.browseMessages': 'Mesajları aç',
  'mobile.writeMessage': 'Bir mesaj yaz',
  'mobile.send': 'Mesaj gönder',
...
// Languages without dedicated mobile-shell copy use the established English
// wording until that catalog receives a complete human translation.
const mobileFallback = Object.fromEntries(
  Object.entries(en).filter(([key]) => key.startsWith('mobile.')),
);

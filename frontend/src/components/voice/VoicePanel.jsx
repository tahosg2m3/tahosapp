      ...
      {showSettings && (
        <div className="custom-scrollbar absolute bottom-full right-4 z-[70] mb-2 max-h-[min(64vh,560px)] w-[min(760px,calc(100%-2rem))] overflow-y-auto rounded-xl border border-white/[0.1] bg-[#0f172a] p-4 shadow-2xl">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            ...
            {!nativeAndroid && <label className="text-[10px] font-bold uppercase text-[#64748b]">Stream quality<select value={screenSharePreset} onChange={event => setScreenSharePreset(event.target.value)} className="mt-1.5 w-full rounded-lg border border-white/[0.08] bg-[#151d2c] px-2 py-2 text-xs text-[#cbd5e1] outline-none"><option value="720p30">720p / 30 FPS</option><option value="1080p30">1080p / 30 FPS</option><option value="1080p60">1080p / 60 FPS</option><option value="2160p30">4K / 30 FPS</option></select></label>}

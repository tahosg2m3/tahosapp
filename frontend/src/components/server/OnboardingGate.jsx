  ...
  return (
    <div className="fixed inset-0 z-[120] flex items-center justify-center bg-[#020617]/90 p-5 backdrop-blur-xl">
      <section className="custom-scrollbar max-h-[90vh] w-full max-w-2xl overflow-y-auto rounded-3xl border border-white/[0.09] bg-[#0f172a] p-7 shadow-2xl">
        ...
        <div className="text-center"><h1 className="text-2xl font-bold text-white">Welcome to {currentServer.name}</h1><p className="mx-auto mt-2 max-w-lg text-sm leading-6 text-[#94a3b8]">{config.welcomeMessage || 'Review the community rules and choose your interests before joining.'}</p></div>
